...
& $GLSLC_BIN shaders\spinning_triangle.vert -o ..\assets\spinning_triangle_vert.spv
& $GLSLC_BIN shaders\spinning_triangle.frag -o ..\assets\spinning_triangle_frag.spv
Pop-Location
