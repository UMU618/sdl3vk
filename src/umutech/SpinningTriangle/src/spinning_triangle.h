...
class SpinningTriangle {
 public:
  SpinningTriangle() noexcept = default;
  ~SpinningTriangle();
  SpinningTriangle(const SpinningTriangle&) noexcept = delete;
  SpinningTriangle& operator=(const SpinningTriangle&) noexcept = delete;
  SpinningTriangle(SpinningTriangle&&) noexcept = delete;
  SpinningTriangle& operator=(SpinningTriangle&&) noexcept = delete;
 ...
 private:
  ...
  bool CreateSynchronizationObjects() noexcept;  // 14
  
  bool RecordCommandBuffer(std::uint32_t image_index) noexcept;
